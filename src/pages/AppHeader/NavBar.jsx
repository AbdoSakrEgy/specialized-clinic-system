        ...
        <React.Fragment>
            <nav className="hv-bc h-20 px-10 shadow-md sticky top-0 bg-white">
                ...
                <div className="hv-bc text-lg font-bold text-blue-2" id="myDIV">
                    ...
                    <Link2 to="AboutUs" className="ml-10 nav-item" smooth={true} duration={100} spy={true} spyThrottle={0} offset={-135}>
                        <Link to="/">
                            <div className="inline-block py-3">من نحن</div>
                        </Link>
                    </Link2>

                    <Link2 to="BandAidSection" className="ml-10 nav-item" smooth={true} duration={100} spy={true} spyThrottle={0} offset={-135}>
                        <Link to="/">
                            <div className="inline-block py-3">الإسعافات الأولية</div>
                        </Link>
                    </Link2>

                    <Link2 to="AppointmentSection" className="ml-10 nav-item" smooth={true} duration={100} spy={true} spyThrottle={0} offset={-135}>
                        <Link to="/">
                            <div className="inline-block py-3">الحجز</div>
                        </Link>
                    </Link2>

                    <Link2 to="MedicalStaff" className="ml-10 nav-item" smooth={true} duration={100} spy={true} spyThrottle={0} offset={-135}>
                        <Link to="/">
                            <div className="inline-block py-3">الطاقم الطبي</div>
                        </Link>
                    </Link2>

                    <Link2 to="MedicalServices" className="ml-10 nav-item" smooth={true} duration={100} spy={true} spyThrottle={0} offset={-135}>
                        <Link to="/">
                            <div className="inline-block py-3">الخدمات الطبية</div>
                        </Link>
                    </Link2>
                    <Link2 to="HeaderSection" className="ml-10 nav-item" smooth={true} duration={100} spy={true} spyThrottle={0} offset={-135}>
                        <Link to="/">
