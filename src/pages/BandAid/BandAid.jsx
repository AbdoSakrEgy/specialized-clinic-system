...
const BandAid = () => {
    return ( 
        <React.Fragment>
            <div  id="BandAidSection">
                <div className="text-5xl text-center pt-7 pb-3">الإسعافات <span className="text-blue-1">الأولية</span></div>
                <div className="flex flex-wrap p-5 pb-40 justify-between">
                    {/* ---------card breaking--------- */}
